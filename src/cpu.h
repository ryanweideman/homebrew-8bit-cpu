...
const Instruction I_STA  = {Opcode::STI, M_STI, "sti", 3};
const Instruction I_STI  = {Opcode::STA, M_STA, "sta", 2};
...
const Instruction I_MOVA = {Opcode::MOVA, M_MOVA, "mova", 1};
const Instruction I_MOVB = {Opcode::MOVB, M_MOVB, "movb", 1};
